...
public class ClotingItemController {
    ...
    public ResponseEntity<List<ClothingItem>> getAllClotingItems() {
        List<ClothingItem> clothingItemsList = clothingItemService.getAllClotingItems();
        if (clothingItemsList.isEmpty()) {
            return ResponseEntity.noContent().build();  
        }
        return ResponseEntity.ok(clothingItemsList);
    }
    ...
    public ResponseEntity<ClothingItem> createClothingItem(@RequestBody ClothingItem newClothingItem) {
        ...
        return ResponseEntity.created(URI.create(ApiRoutes.CLOTHING_ITEMS + createdClothingItem.getId())).body(createdClothingItem);
    }
