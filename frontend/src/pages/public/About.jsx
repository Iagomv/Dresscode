  ...
  return (
    ...
    >
      <Container>
        ...
        <MembershipTypeSection membershipText={t('membership')} typeText={t('type')} />
      </Container>

      <LocationSection name={t('location.name')} address={t('location.address')} founded={t('location.founded')} />
    </div>
  )
}
